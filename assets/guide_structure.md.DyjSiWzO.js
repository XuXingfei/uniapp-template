import{_ as n,c as s,o as e,af as p}from"./chunks/framework.BZAhBqlD.js";const u=JSON.parse('{"title":"项目结构说明","description":"","frontmatter":{},"headers":[],"relativePath":"guide/structure.md","filePath":"guide/structure.md"}'),i={name:"guide/structure.md"};function l(o,a,t,c,r,d){return e(),s("div",null,[...a[0]||(a[0]=[p(`<h1 id="项目结构说明" tabindex="-1">项目结构说明 <a class="header-anchor" href="#项目结构说明" aria-label="Permalink to “项目结构说明”">​</a></h1><p>本项目采用清晰的目录结构组织代码，便于维护和扩展。以下是项目的主要目录和文件说明：</p><h2 id="项目目录树" tabindex="-1">项目目录树 <a class="header-anchor" href="#项目目录树" aria-label="Permalink to “项目目录树”">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>uni_template/</span></span>
