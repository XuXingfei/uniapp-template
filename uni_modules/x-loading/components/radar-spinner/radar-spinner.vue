<template>
    <view class="radar-spinner" :style="spinnerStyle">
        <view v-for="(cs, index) in circlesStyles" :key="index" class="circle" :style="cs">
            <view class="circle-inner-container" :style="circleInnerContainerStyle">
                <view class="circle-inner" :style="circleInnerStyle" />
            </view>
        </view>
    </view>
</template>
